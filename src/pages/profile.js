    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 p-8">
      ...
      <div className="relative bg-white/80 backdrop-blur-lg rounded-3xl shadow-2xl p-8 w-full max-w-md border border-white/20">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          {/* Remove Image Button - Only shows when there's an uploaded image */}
          {user.avatar && user.avatar !== "/default-avatar.png" && (
            <button
              onClick={handleRemoveImage}
              className="mt-3 px-6 py-2 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-xl hover:from-red-600 hover:to-red-700 transition-all duration-300 shadow-lg cursor-pointer font-medium flex items-center space-x-2 transform hover:scale-105 active:scale-95"
            >
              <span>🗑️</span>
