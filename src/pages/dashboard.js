...
return (  
    <div className="min-h-screen relative flex items-center justify-center px-4 overflow-hidden">  
        ...
        {/* Floating Profile Avatar with Name */}  
        <motion.div
    className="absolute top-6 left-6 flex items-center space-x-3 cursor-pointer z-10"
...
>
    ...
    <span className="text-white font-semibold text-lg">{user.name || "User"}</span>
        ...
        >  
            <h1 className="text-4xl font-bold text-white mb-2 font-serif">Welcome to Luxury Stays</h1>  
            <p className="text-white/80 text-lg">How can we assist you today?</p>  
        </motion.div>  

        {/* Buttons Grid */}  
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl w-full z-10 mt-32">  
